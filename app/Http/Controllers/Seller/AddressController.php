...

{
...

    {
        ...
        $data['states'] = DB::table('states')->where('country_id', $data['address_data']->country_id)->get();

        $data['cities'] = DB::table('cities')->where('state_id', $data['address_data']->state_id)->get();
