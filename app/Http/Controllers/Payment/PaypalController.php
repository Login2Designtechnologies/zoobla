...

{
    ...
    public function generateAccessToken()
    {
        ...
        ])->asForm()->post("{$this->base}/v1/oauth2/token", [
    ...
    public function createOrder(Request $request)
    {
        ...
        $responsefirst = Http::withToken($accessToken)->post("{$this->base}/v2/checkout/orders", [
            ...
            'purchase_units' => [
                [
                    'amount' => [
                        ...
                        'currency_code' => strtolower(\App\Models\Currency::findOrFail(get_setting('system_default_currency'))->code),
        ...
        $response = $this->handleResponse($responsefirst);

        return response()->json($response['jsonResponse'], $response['httpStatusCode']);
    }
    ...
    public function captureOrder($orderID)
    {
        ...
        $responsefirst = Http::withToken($accessToken)->post("{$this->base}/v2/checkout/orders/{$orderID}/capture");
