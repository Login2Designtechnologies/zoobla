...

{
    ...
    public function service_commission(Request $request) 
    
    {

        return view('backend.sellers.seller_commission.service-commission');
    ...
    public function payout_transaction_update(Request $request){
        ...
        flash(translate('Payout Transaction Day updated successfully'))->success();
