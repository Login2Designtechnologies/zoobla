...

{
    ...
    public function index(Request $request, $category_id = null, $brand_id = null , $partner_code = null)

    {
        $partner_code = null;

        if (isset($_GET['partner-code']) && !empty($_GET['partner-code'])) {

            Session::put('partner-code' ,$_GET['partner-code']);

            $partner_code = $_GET['partner-code'];
        }
        ...
        return view('frontend.product_listing', compact('products', 'query', 'category_id', 'brand_id', 'sort_by', 'seller_id', 'min_price', 'max_price', 'attributes', 'selected_attribute_values', 'colors', 'selected_color' ,'partner_code'));
