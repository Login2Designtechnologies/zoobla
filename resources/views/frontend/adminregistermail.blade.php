                                    ...
                                    <tr>
                                        <td style="padding: 0 35px;">
                                            ...
                                            <ul style="list-style-type: none;">
                                                <li style="color: #455056;">User name: <span style="color: #2bacd1">{{$request['name']}}</span></li>
                                                <li style="color: #455056;">User email: <span style="color: #2bacd1">{{$request['email']}}</span></li>
                                            </ul>
