...
@section('panel_content')
    ...
    <!-- Address -->
    <div class="card rounded-0 shadow-none border" id="Address_add">
    ...
    {{-- <form action="{{ route('acount.store') }}" method="POST">
        ...
        <div class="card rounded-0 shadow-none border">
          ...
          <div class="card-header pt-4 border-bottom-0">
              ...
              <h5 class="mb-0 fs-18 fw-700 text-dark">{{ translate('Enroll Ach')}}</h5>
          ...
          <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <label class="fs-14">{{ translate('Account Holder Name') }}</label>
                    ...
                    <div class="col-md-10">
                        ...
                        <input type="text" class="form-control rounded-0" placeholder="{{ translate('Account holder Name')}}" name="account_holder_name" value="" />
                    ...
                    <div class="col-md-2">
                        ...
                        <label class="fs-14">{{ translate('Account Holder Type') }}</label>
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control rounded-0" placeholder="{{ translate('Account Holder Type')}}" name="account_holder_type" value="" />
                    ...
                    <div class="col-md-2">
                         ...
                         <label class="fs-14">{{ translate('Routing Number') }}</label>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control rounded-0" placeholder="{{ translate('Routing Number')}}" name="routing_number" value="" />
                    ...
                    <div class="col-md-2">
                        ...
                        <label class="fs-14">{{ translate('Account number') }}</label>
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control rounded-0" placeholder="{{ translate('Account Number')}}" name="account_number" value="" />
                    ...
                    <button type="submit" class="btn btn-primary rounded-0 w-150px mt-3">{{translate('Submit')}}</button>
        ...
        <div class="card rounded-0 shadow-none border">
          ...
          <div class="card-body">
              <div class="row">
                  ...
                  <div class="col-md-10">
                      <div class="input-group mb-3">
                        <input type="text" class="form-control rounded-0" placeholder="{{ translate('Your Email')}}" name="email" value="{{ Auth::user()->email }}" />
