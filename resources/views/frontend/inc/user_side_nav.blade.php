<style>
    .aiz-user-sidenav .avatar.avatar-md.mb-3{
        outline: 5px solid #20a1e3;
    }
    .aiz-user-sidenav .avatar img{
        border: 3px solid #16e1ce;
    }
    .aiz-user-sidenav-wrap.position-relative.z-1.rounded-0 {
        box-shadow: rgba(70, 151, 191, 0.2) 0px 2px 8px 0px;
    }
</style>
    ...
    <div class="aiz-user-sidenav overflow-auto c-scrollbar-light px-4 pb-4">
        ...
        <div class="p-4 text-center mb-4 border-bottom position-relative">
            ...
            @if (Auth::user()->phone != null)
                <div class="text-truncate opacity-60 fs-12 d-none">{{ Auth::user()->phone }}</div>
            <!-- Email -->
            @else
            ...
            <ul class="aiz-side-nav-list mb-3 pb-3 border-bottom" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('purchase_history.index') }}"
                        ...
                        <span class="aiz-side-nav-text ml-3">{{ translate('Order History') }}</span>
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('service-history') }}" class="aiz-side-nav-link {{ areActiveRoutes(['service-history']) }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        ...
                        <span class="aiz-side-nav-text ml-3">{{ translate(' Service Details') }}</span>
                    </a>
                </li>
