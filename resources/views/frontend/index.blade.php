...
@section('content')
    ...
    <div class="home-banner-area mb-3 home-slider" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
                        ...
                        <div class="aiz-carousel dots-inside-bottom mobile-img-auto-height" data-autoplay="true" data-arrows="true" data-dots="true">
                            ...
                            @foreach ($slider_images as $key => $value)
                                ...
                                <div class="carousel-box">
                                    ...
                                    <a class="w-100" href="{{ json_decode(get_setting('home_slider_links'), true)[$key] }}">
    ...
    <div class="mb-2 mb-md-3 mt-2 mt-md-3">
        ...
        <div class="container">
            ...
            <div class="w-100">
                ...
                <div class="aiz-carousel gutters-16 overflow-hidden arrow-inactive-none arrow-dark arrow-x-15" data-items="{{ count($banner_1_imags) }}" data-xxl-items="{{ count($banner_1_imags) }}" data-xl-items="{{ count($banner_1_imags) }}" data-lg-items="{{ $data_md }}" data-md-items="{{ $data_md }}" data-sm-items="1" data-xs-items="1" data-arrows="true" data-dots="true" data-autoplay="true" data-infinite="true">
    ...
    @if (count($featured_categories) > 0)  
       ...
       <section class="mb-2 mb-md-3 md-3">
            ...
            <div class="">
                ...
                <div class="bg-white">  
                   ...
                   <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">  
                        ...
                        <!-- Title -->
                         ...
                         <h2 class="category-heading my-5 text-center w-100">

                            <span class="fw-bold">{{ translate('Shop By Category') }}</span>
                ...
                <div class="bg-white px-sm-3">
                    ...
                    <div class="aiz-carousel sm-gutters-17" data-items="5" data-xxl-items="5" data-xl-items="5" data-lg-items="5" data-md-items="3" data-sm-items="3" data-xs-items="1" data-arrows="true" data-dots="false" data-autoplay="true" data-infinite="true">
    ...
    @endif  
     ...
     <!-- foreever banner start -->
     <section class="banner-ad1">
            <div class="banner-ad-box">
                <div class="container">
                    <div class="row">
                        <div class="banner-ad-contnet">
                            <div style="opacity: 1;text-align: right;margin-top: 9%; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" class="button-wrapper flex new">
                                <a href="{{url('/category/Smart-Solution-wilBZ')}}" class="zoobla-theme-btn ">
    ...
    <section class="shop-area py-5 px-3">
            <div class="container">
                <div class="row d-flex justify-content-between ">

                    <div class="col-sm-12 col-md-5 col-gl-5 shobbox aos-init" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
                        <div class="shop-area-box1">
                            <img src="{{ static_asset('assets/images/banner_pc_1180_664_42dae312-64e8-46be-bcbf-c0c34a1dccd1.png') }}" alt="">
                            <div class="shop-area-btn1">
                                <div style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" class="button-wrapper flex new">
                                    <a href="shop.html" class="zoobla-theme-btn ">
                    ...
                    <div class="col-sm-12 col-md-5 col-gl-5 shobbox aos-init" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
                        <div class="shop-area-box1">
                            <img src="{{ static_asset('assets/images/T2181_PC.png') }}" alt="">
                            <div class="shop-area-btn1">
                                <div style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" class="button-wrapper flex new">
                ...
                <div class="shop-area-popup mobile">

                </div>

                <div class="row d-flex justify-content-between" style="margin-top: 3rem!important;">

                    <div class="col-sm-12 col-md-5 col-gl-5 shobbox aos-init" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
                        <div class="shop-area-box1 shop-area-box2">
                        <img src="{{ static_asset('assets/images/20220705-192730.png') }}" alt="">
                            <div class="shop-area-btn2">
                                <div style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" class="button-wrapper flex new">
                                    <a href="#" class="zoobla-theme-btn ">
                    ...
                    <div class="col-sm-12 col-md-5 col-gl-5 shobbox aos-init" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
                        <div class="shop-area-box1">
                            <img src="{{ static_asset('assets/images/x8-hybrid.png') }}" alt="">
                            <div class="shop-area-btn2">
                                <div style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" class="button-wrapper flex new">
                                    <a href="#" class="zoobla-theme-btn ">
            ...
            <div class="shop-area-popup dekstop ">
                <div class="shop-area-content text-center">
                    <h2>Zoobla Protects Your Livelihood.</h2>
                    <p class="text-info">BY PROTECTING YOUR PEOPLE. Zoobla's video surveillance platform connects your security camera footage with your POS data and creates a dashboard of analytics and searchable moments.</p>
                </div>
            </div>
        </section>
        ...
        <!--  balck camera section  -->
        <section class="zoobla-info py-5 ps-5 pe-1 ">
            <div class="container">
                <div class="row d-flex justify-content-between">
                    <div class="col-sm-12 col-md-12 col-lg-6 aos-init" data-aos="fade-right" data-aos-duration="2000">
                        <h2 class="text-white fw-bold mb-4">Why Zoobla ?</h2>

                        <div class="info-box text-white my-5">
                            <h3>Touch Screen Panel</h3>
                            <h6>The main hub links burglary and environmental sensors and communicates with six monitoring stations.
                            </h6>
                        </div>

                        <div class="info-box text-white my-5">
                            <h3>Burglary and Intrusion Sensors</h3>
                            <h6>Door, window, motion, and glass break detectors designed to monitor and protect your home.
                            </h6>
                        </div>

                        <div class="info-box text-white my-5">
                            <h3>Cameras</h3>
                            <h6>Know if anyone drops by unannounced, whether they're neighbors or intruders.</h6>
                        </div>

                        <div class="info-box text-white my-5">
                            <h3>Environmental Sensors</h3>
                            <h6>Safeguard your home against fire, smoke, and indoor leaks and floods.</h6>
                        </div>

                    </div>

                    <div class="col-sm-12 col-md-12 col-lg-6">
                        <div class="zoobla-info-imgs align-items-center">
                            <div class="row">
                                <div class="col-4 black_image_1"><img src="{{ static_asset('assets/images/human-det-cam-img2-600x600.png') }}" alt="" width="90%"></div>
                                <div class="col-4 black_image_2"><img src="{{ static_asset('assets/images/fishimg-2-300x300.png') }}" alt="" width="90%"></div>
                                <div class="col-4 black_image_3"><img src="{{ static_asset('assets/images/8mpp-dome-cam-img2-300x300.png') }}" alt="" width="90%"></div>
                            </div>

                            <div class="row justify-content-end align-items-center">
                                <div class="col-5 black_image_4"><img src="{{ static_asset('assets/images/outdoor-ip-img2-600x600.png') }}" alt="" width="90%"></div>
                                <div class="col-5 black_image_5"><img src="{{ static_asset('assets/images/shop-slide-img-1.png') }}" alt="" width="90%"></div>
                            </div>

                            <div class="row align-items-center">
                                <div class="col-4 black_image_6"><img src="{{ static_asset('assets/images/hik-human-cam-img2-300x300.png') }}" alt="" width="90%"></div>
                                <div class="col-4 black_image_7"><img src="{{ static_asset('assets/images/dome-human-cam-img2-300x300.png') }}" alt="" width="90%"></div>
                                <div class="col-4 black_image_8"><img src="{{ static_asset('assets/images/dome-img2.png') }}" alt="" width="90%"></div>
                            </div>
                        </div>
        ...
        <!--  big product area  -->
        <section class="zoobla-details mt-4">
            <div class="container-fluid" style="padding:0px;">
                <div class="row big_camera_home">
                    <div class="col-sm-6">
                        <div class="zoobla-details-img">
                            <div class="row">
                                <div class="zoobla-details-1">
                                    <img src="{{ static_asset('assets/images/Group 6.png') }}" alt="" width="80%" class="vert-move">
                                </div>
                            </div>

                            <div class="row">
                                <div class="zoobla-details-2">
                                    <img src="{{ static_asset('assets/images/Group 7.png') }}" alt="" width="60%">
                                </div>
                            </div>

                            <div class="row">
                                <div class="zoobla-details-3">
                                    <img src="{{ static_asset('assets/images/Group 8.png') }}" alt="" width="80%">
                                </div>
                            </div>
                    ...
                    <div class="col-sm-6 d-flex flex-column justify-content-between tzt">
        ...
        <section class="zoobla-process py-5 mt-5">
    <div class="container-fluid">
        <div class="row">
            <div class="zoobla-process-heading text-center pt-5 mt-5">
                <h5 style="color: #2ebab5;" class="mb-0">TRUE CLOUD ARCHITECTURE</h5>
                <h2 class="my-2">Cloud Storage Process</h2>

                <div id="cs" class="tab-pane fade container mt-5">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 mx-auto">
                                <img class="img-fluid" src="{{asset('public/assets/images/zoobla-cloud-sec.png')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!--</div>-->
        ...
        <section class="subscribe">
            <div class="container">
                <div class="row">
                    <div class="subscribe-box text-center pt-5 mt-5 aos-init" data-aos="fade-up" data-aos-duration="1000">
                        <h1 style="color:white">CHECK OUT OUR STORE</h1>
                    </div>
                    <div class="subscribe-btn aos-init" data-aos="fade-down" data-aos-duration="1000">
                        <div style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" class="button-wrapper flex new">
                            <a href="#" class="zoobla-theme-btn ">

                                </a><div class="check-btn"><a href="{{url('/category/Home-Solution-dHVIz')}}" class="zoobla-theme-btn ">
                                    <div class="button-text-wrapper">
                                        <div class="dark-button-text">Shop Now</div>
                                    </div>
    ...
    <?php
	 ...
	 ?>
        ...
        @if(!empty($reviews))
        <section class="third_cloud_section">
            <div class="container">
       
                <div class="row">
                    <div class="col" style="text-align: center;">
                        <h1 class="second_cloud_title pt-5 mt-4">Our Client Reviews</h1>
                    </div>
                </div>
                <div class="review-slider owl-carousel owl-theme">
                @foreach($reviews as $review)
                    @php
                        $reviewdata = DB::table('users')->where('id', $review->user_id)->first();
                    ...
                    <div class="box_cloud">
                        @if($reviewdata->avatar)
                            <img src="{{ $reviewdata->avatar }}" class="center-block img-circle" alt="Customer Feedback">
                        @else
                            <img src="{{ static_asset('assets/img/avatar-place.png') }}" class="center-block img-circle" alt="Customer Feedback">
                        @endif
                            <div class="star text-center pt-3 mt-5">
                                @for ($i = 1; $i <= 5; $i++)
                                    @if ($i <= $rating)
                            ...
                            <div class="pt-4 text-center">
                                <h3 class="customer-name">{{ $reviewdata->name }}</h3>
                                <p>{{ $review->comment }}</p>
                            </div>
                        </div>
                    </div>
    ...
    <div id="section_newest" class="d-none">
    ...
    <div class="mb-2 mb-md-3 mt-2 mt-md-3 d-none" style="background-color: {{ get_setting('cupon_background_color', '#292933') }}">
