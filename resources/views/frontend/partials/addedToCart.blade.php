<div class="modal-body px-4 py-5 c-scrollbar-light">
    ...
    <div class="media mb-1">
        @if(isset($product->thumbnail_img) AND !empty($product->thumbnail_img))
        ...
        @else
        <img src="{{ static_asset('assets/img/placeholder.jpg') }}" data-src="{{ static_asset('assets/img/placeholder.jpg') }}"
