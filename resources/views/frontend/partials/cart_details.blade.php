            ...
            <div class="col-xxl-8 col-xl-10 mx-auto">
                ...
                <div class="border bg-white p-3 p-lg-4 text-left">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item px-0">
                                ...
                                <div class="row gutters-5 d-none d-lg-flex border-bottom mb-3 pb-3 text-secondary fs-12">
                                    ...
                                    <div class="col col-md-1 fw-600">{{ translate('Duration')}}</div>
                            ...
                            @if(isset($cloud) && $cloud !== null)
                                ...
                                <li class="list-group-item px-0">
                                    ...
                                    <div class="row gutters-5 align-items-center">
                                        ...
                                        <!-- Product Image & name -->
                                        <div class="col-md-5 d-flex align-items-center mb-2 mb-md-0">
                                            <span class="fs-14">Cloud Storage</span>
                                        </div>

                                        <div class="col-md col-5 order-4 order-md-0 my-3 my-md-0">
                                            <span class="opacity-60 fs-12 d-block d-md-none">Duration</span>
                                            <span class="fw-700 fs-16 text-primary">{{$cloud->storage_duration}} Days</span>
                                        </div>
                                        <!-- Total -->
                                        <div class="col-md col-5 order-4 order-md-0 my-3 my-md-0">
                                            <span class="opacity-60 fs-12 d-block d-md-none">Total</span>
                                            <span class="fw-700 fs-16 text-primary">${{$cloud->amount}}</span>
                                        </div>
                                        <!-- Remove From Cart -->
                                        <div class="col-md-auto col-6 order-5 order-md-0 text-right">
                                            <a href="javascript:void(0)" onclick="removeFromCartView(event, 161)" class="btn btn-icon btn-sm btn-soft-primary bg-soft-warning hov-bg-primary btn-circle">
                                                <i class="las la-trash fs-16"></i>
                                            </a>
                                        </div>
                                    </div>
                    ...
                    <div class="px-0 py-2 mb-4 border-top d-flex justify-content-between">
                        ...
                        @if(isset($cloud) && $cloud !== null)
                            <span class="fw-700 fs-16">{{ single_price($total+$cloud->amount) }}</span>
                        @else
