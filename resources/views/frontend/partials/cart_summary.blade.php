            ...
            <tbody>
                ...
                <tr class="cart_item">
                        ...
                        <td class="product-total text-right pr-0 fs-14 text-primary fw-600 border-top-0 border-bottom">
                            ...
                            <span class="pl-4 pr-0">${{ ($cart_detail->amount) }}</span>
        ...
        <table class="table" style="margin-top: 2rem!important;">
            ...
            <tfoot>
                ...
                <tr class="cart-subtotal">
                    ...
                    <td class="text-right pr-0 fs-14 pt-0 pb-2 fw-600 text-primary border-top-0">
                        ...
                        @if(isset($cart_detail) && $cart_detail !== null)
                            ...
                            <span class="fw-600">{{ single_price($subtotal+$cart_detail->amount) }}</span>
                ...
                <tr class="cart-shipping">
                    ...
                    <th class="pl-0 fs-14 pt-0 pb-2 text-dark fw-600 border-top-0">{{ translate('Bundle Discount')}}</th>

                    <td class="text-right pr-0 fs-14 pt-0 pb-2 fw-600 text-primary border-top-0">

                        <span class="fw-600">{{ single_price($bundle_descount) }}</span>
