...
<style>
    ...
    padding: 0;
    /* margin: 10px; */
    /* margin: 0px 10px 10px 0px; */margin-bottom: 10px;
    }
    .filter-bg{
        background: #e7e7e7;
        margin-bottom: 10px;
            ...
            <form class="" id="search-form" action="" method="GET">
                <div class="row">
                        ...
                        <div class="aiz-filter-sidebar collapse-sidebar-wrap sidebar-xl sidebar-right z-1035">
                            ...
                            <div class="collapse-sidebar c-scrollbar-light text-left">
                                ...
                                <div class="bg-white border mb-3">
                                    <div class="fs-16 fw-600 border p-2 filter-bg m-0">
                                        <a href="#collapse_1" class="dropdown-toggle filter-section text-dark d-flex align-items-center justify-content-between" data-toggle="collapse" aria-expanded="false">
                                            {{ translate('Categories')}} <span class='icon'></span>
                                        </a>
                                    </div>
                                    ...
                                    <div class="bg-white border mb-3">
                                        <div class="fs-16 fw-700 p-3">
                                            <a href="#" class="dropdown-toggle text-dark filter-section collapsed d-flex align-items-center justify-content-between" 
                                                data-toggle="collapse" data-target="#collapse_{{ str_replace(' ', '_', $attribute->name) }}" style="white-space: normal;" aria-expanded="false">
                                                {{ $attribute->getTranslation('name') }} <span class='icon'></span>
                                            </a>
                                        </div>
                                        @php
                                            $show = '';
                    ...
                    <div class="col-xl-9">
                        ...
                        <!-- Top Filters -->
                        <div class="text-left filter-bg">
                            <div class="row flex-wrap align-items-center m-0">
                                <div class="col-lg-9 col-10 p-0">
                                    <h1 class="fs-20 fs-md-20 fw-600 text-dark mb-0">
                                        @if(isset($category_id))
                                            {{ get_single_category($category_id)->getTranslation('name') }}
                                        @elseif(isset($query))
                                ...
                                <div class="col-6 col-lg-3 mb-2 mt-2 d-flex align-items-center">
                                    <div class='w-50'>
                                        <h6 class='mb-0'>{{ translate('Sort by')}}</h6>
                                    </div>
                        ...
                        <div>
                            <div class="form-row">
                                @foreach ($products as $key => $product)
                                    ...
                                    @if(Session::has('partner-code'))
                                        @php
                                            $product['partner-code'] = $partner_code ?? Session::get('partner-code');
                                        @endphp
                                    @endif

                                    {{-- @dd($product); --}}
                                    <div class="col-md-4 d-flex">
                                        <div class="has-transition hov-shadow-out z-1 custom-call w-100">
