...
@section('content')
    ...
    <section class="py-4">
        ...
        <div class="container text-left order-confirm">
            ...
            <div class="row">
                ...
                <div class="col-xl-8 mx-auto">
                    ...
                    @php
                        ...
                        $cloude_detail = DB::table('cloude_service')->first() ?? null ;
                        // dd($cloude_detail);
                    @endphp
                    ...
                    <div class="mb-4 bg-white p-4 border pb-2">

                        <h5 class="fw-600 mb-2 fs-16 text-soft-dark pb-2 border-bottom">{{ translate('Order Summary')}}</h5>
                            ...
                            <div class="col-md-6">
                                ...
                                <table class="table fs-14 text-soft-dark">
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-top-0 py-2">{{ date('m-d-Y H:i A', $first_order->date) }}</td>
                            ...
                            <div class="card-body pb-0">
                                ...
                                <div>
                                    ...
                                    <div class="table-responsive-md">
                                        ...
                                        <table class="table text-soft-dark fs-14">

                                            <thead class="thead-light-theme">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($order->orderDetails as $key => $orderDetail)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="border-top-0 border-bottom text-right">{{ single_price($orderDetail->price) }}</td>
                                    ...
                                    @if($cloude_detail != null && !empty($cloude_detail))

                                        <h5 class="fw-600 text-soft-dark mb-3 fs-16 pb-2">{{ translate('Cloud Details')}}</h5>
                                            ...
                                            <div class="table-responsive-md">
                                                ...
                                                <table class="table text-soft-dark fs-14">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach(json_decode($cloude_detail->camera_detail) as $key => $value)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="border-top-0 border-bottom">
                                                                    ...
                                                                    {{$cloude_detail->storage_duration}} Days.

                                                                </td>

                                                                <td class="border-top-0 border-bottom text-right">{{ single_price($value->qty * $value->cam_price) }}</td>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right border-top-0 pr-0 py-2">
                                                            ...
                                                            @if($cloude_detail != null )

                                                            <span class="fw-600">{{ single_price($order->orderDetails->sum('price')+$cloude_detail->amount) }}</span>
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <th class="border-top-0 py-2">{{ translate('Bundle Discount')}}</th>

                                                        <td class="text-right border-top-0 pr-0 py-2">

                                                            @if(isset($cloude_detail) && $cloude_detail != null)

                                                                <span>{{ single_price(($order->orderDetails->sum('price') + $cloude_detail->amount)+ $order->coupon_discount + $order->orderDetails->sum('tax')+ $order->orderDetails->sum('shipping_cost') -( $combined_order->grand_total)) }}</span>
