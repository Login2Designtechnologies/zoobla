            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <a href="{{ route('seller.orders.index') }}"
                        ...
                        <span class="aiz-side-nav-text">{{ translate('Orders History') }}</span>
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <a href="{{ route('seller.service.service_list') }}"

                       class="aiz-side-nav-link {{ areActiveRoutes(['seller.service.service_list']) }}">

                        <i class="las la-money-bill aiz-side-nav-icon"></i>

                        <span class="aiz-side-nav-text">{{ translate('Services History') }}</span>
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <a href="{{ route('seller.service.commission_history') }}" class="aiz-side-nav-link">
