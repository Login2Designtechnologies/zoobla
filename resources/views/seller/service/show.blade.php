        ...
        <div class="card-body">
            ...
            <div class="row gutters-5">
                ...
                @php
                    ...
                    $payment_status = $info->orderDetails->where('seller_id', $info->seller_id)->first()->payment_status;
                ...
                @if (get_setting('product_manage_by_admin') == 0)
                    ...
                    <div class="col-md-3 ml-auto">
                        ...
                        @if (($info->payment_type == 'cash_on_delivery' || (addon_is_activated('offline_payment') == 1 && $info->manual_payment == 1)) && $payment_status == 'unpaid')
            ...
            <div class="row gutters-5 mt-2">
                ...
                <div class="col text-md-left text-center">
                    ...
                    {{-- @if ($info->manual_payment && is_array(json_decode($info->manual_payment_data, true)))
                        ...
                        <a href="{{ uploaded_asset(json_decode($info->manual_payment_data)->photo) }}"

                            target="_blank"><img

                                src="{{ uploaded_asset(json_decode($info->manual_payment_data)->photo) }}" alt=""
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-info text-bold text-right">{{ $info->code }}</td>
                            ...
                            <tr>
                                ...
                                <td class="text-right">{{ date('d-m-Y h:i A', $info->date) }}</td>
                            ...
                            <tr>
                                ...
                                <td class="text-right">{{ $info->additional_info }}</td>
                    ...
                    <table class="table-bordered aiz-table invoice-summary table">
                        ...
                        <thead>
                            ...
                            <tr class="bg-trans-dark">
                                ...
                                <th data-breakpoints="md" class="min-col">#</th>

                                <th width="30%" class="text-uppercase">{{ translate('Service Name') }}</th>

                                <th data-breakpoints="md" class="text-uppercase">{{ translate('Shipping') }}</th>
            ...
            <div class="clearfix float-right">
                ...
                <div class="no-print text-right">
                    ...
                    <a href="{{ route('seller.service_invoice.download', $order->id) }}" type="button"
