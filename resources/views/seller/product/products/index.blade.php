                            ...
                            <tr>
                               ...
                               {{--  <td>
                                ...
                                <td>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p class="mb-0 pl-2">{{ $product->getTranslation('name') }}</p>
                                    </div>
                              ...
                              {{--  <td>
                                ...
                                <td class="text-right">
                                  ...
                                  <a href="{{ route('product', $product->slug) }}" target="_blank" class="text-reset" title="View">

                                        <i class="las la-eye view" style="font-size: 23px;"></i>
