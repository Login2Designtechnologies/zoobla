...
{{-- @dd(get_order_commission()); --}}

    <div class="row">

        <div class="col-sm-6 col-md-6 col-xxl-4">

            <div class="card shadow-none mb-4 bg-primary py-4 bg-grd-primary">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col">
                            ...
                            <p class="small text-muted mb-0">
                                ...
                                <span class="fs-14 text-light">{{ translate('Sold Products') }}</span>

                            </p>

                            <h3 class="mb-0 text-white fs-30">
                                @php
                                    $Totalsoldproduct = DB::table('order_details')
                                                        ->join('orders' , 'orders.id' ,'=' ,'order_details.order_id')
                                                        ->where('orders.payment_status', 'paid')
                                                         ->where('order_details.product_referral_code', '=', base64_encode (Auth::user()->partner_code))->count();
                                @endphp
     ...
     {{-- <div class="col-sm-6 col-md-6 col-xxl-4">
        ...
        <div class="col-sm-6 col-md-6 col-xxl-4">
            ...
            <div class="card shadow-none mb-4 bg-primary py-4 bg-grd-success">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col">
                            ...
                            <h3 class="mb-0 text-white fs-30">
                                ...
                                {{ \App\Models\Order::whereHas('orderDetails', function ($query) {
        ...
        <div class="col-sm-6 col-md-6 col-xxl-4">
            ...
            <div class="card shadow-none mb-4 bg-primary py-4 bg-grd-warning">
                        ...
                        <div class="col">
                            ...
                            <h3 class="mb-0 text-white fs-30">
                                ...
                                @php
                                    ...
                                    $orderDetails = \App\Models\OrderDetail::where('product_referral_code', base64_encode (Auth::user()->partner_code))->get();
    ...
    <div class="form-row">
        ...
        <div class="col-sm-6 col-md-6 col-lg-6 mb-2">
            ...
            <div class="card mb-0">
                ...
                @php
                    ...
                    // $orderTotal =  \App\Models\Order::whereHas('orderDetails', function ($query) {
                ...
                <div class="card-body">
                    ...
                    <div class="card-title text-primary fs-16 fw-600 text-center">

                        {{ translate('Sold Amount (Current month)') }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <p>{{ translate('Your Product Sold Amount') }} </p>

                            <h3 class="text-primary fw-600 fs-30">

                                {{-- {{ single_price($orderTotal) }} --}}
                                {{ get_order_commission($current) }}
                            ...
                            <p class="mt-4">
                                ...
                                {{ translate('Last Month') }}: {{ get_order_commission(false , true) }}
                        ...
                        <div class="col-6">
                            ...
                            <p>{{ translate('Your service Sold Amount ')}}</p>
                            <h3 class="text-primary fw-600 fs-30">

                                {{-- {{ single_price($orderTotal) }} --}}
                                {{ get_service_commission($current) }}
                            ...
                            <p class="mt-4">
                                ...
                                {{-- {{ translate('Last Month') }}: {{ single_price($orderTotal) }} --}}
                                {{ translate('Last Month') }}: {{ get_service_commission(false , true) }}
                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col">
                            ...
                            <h3 class="mb-0" style="color: #A9A3CC">
                                ...
                                })->where('delivery_status', 'on_the_way')->count(); }}
        ...
        <div class="col-sm-6 col-md-6 col-lg-3 mb-2">
            ...
            <!-- <a href="{{ route('seller.money_withdraw_requests.index') }}"
                ...
                <div class="card mb-3 p-4 text-center h-220px">
                    <a href="{{ route('seller.money_withdraw_requests.index') }}">
                ...
                <div class="card p-4 text-center h-220px mb-0">

                    <div class="fs-16 fw-600 text-primary">

                        {{ translate('Bank Account Settings') }}
    ...
    <div class="form-row">
        @if(auth::user()->partner_code != null)
            <div class="col-sm-6 col-md-6 col-lg-12 mb-3">
                ...
                <div class="card h-450px mb-0 h-100">
                    ...
                    <div class="card-body">
                        ...
                        <input type="text" value="{{url('/search?partner-code=' . base64_encode(auth::user()->partner_code))}}"  class="form-control" id="copyInput" readonly>
...
$('#update-profile').submit(function(event) {
    ...
    var confirem_bank_acc_no = $('#confirem_bank_acc_no').val();

    if (bank_acc_no != confirem_bank_acc_no) {

        alert('Account No. and Confirm Account No. do not match!');
