...
@section('panel_content')
    ...
    <form action="{{ route('seller.profile.update', $user->id) }}" method="POST" enctype="multipart/form-data" id="update-profile">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <label class="col-md-2 col-form-label" for="name">{{ translate('Partner Url') }}</label>
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <h5 class="mb-0 h6">{{ translate('Bank Account Setting')}}</h5>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <label class="col-md-3 col-form-label">{{ translate('Manual Payment') }}</label>
                ...
                <div class="row">
                    ...
                    <label class="col-md-3 col-form-label" for="bank_name">{{ translate('Name on the account') }}</label>

                    <div class="col-md-9">

                        <input type="text" name="bank_name" value="{{ $user->shop->bank_name }}" id="bank_name" class="form-control mb-3" placeholder="{{ translate('Name on the account')}}">
                ...
                <div class="row">
                    ...
                    <label class="col-md-3 col-form-label" for="bank_acc_name">{{ translate('Account type') }}</label>

                    <div class="col-md-9">

                        <input type="text" name="bank_acc_name" value="{{ $user->shop->bank_acc_name }}" id="bank_acc_name" class="form-control mb-3" placeholder="{{ translate('savings current')}}">
                ...
                <div class="row">
                    ...
                    <label class="col-md-3 col-form-label" for="bank_acc_no">{{ translate('Account no') }}</label>
                ...
                <div class="row">
                    ...
                    <label class="col-md-3 col-form-label" for="bank_acc_no">{{ translate('Confirm Account no') }}</label>

                    <div class="col-md-9">

                        <input type="text" value="{{$user->shop->bank_acc_no }}" id="confirem_bank_acc_no" class="form-control mb-3" placeholder="{{ translate('Confirm Account Number')}}">
