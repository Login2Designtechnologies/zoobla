		...
		<div style="background: #eceff4;padding: 1rem;">
			...
			<table>
				...
				<tr>
					...
					<td class="text-right small"><span class="gry-color small">{{  translate('Order Date') }}:</span> <span class=" strong">{{ date('m/d/Y', $order->date) }}</span></td>
				</tr>
				<tr>
			...
			<table class="padding text-left small border-bottom">
				<thead>
	                <tr class="gry-color" style="background: #eceff4;">
						...
						<th width="15%" class="text-left">{{ translate('Shipping') }}</th>
				...
				<tbody class="strong">
	                ...
	                @foreach (json_decode($info->camera_detail)  as $key => $orderDetail)
						...
						@endif
							...
							<tr class="">
								...
								<td class="currency">{{ single_price($orderDetail->cam_price) }}</td>

								{{-- <td class="currency">{{ single_price($orderDetail->tax/$orderDetail->quantity) }}</td> --}}
								<td class="currency">$0.00</td>

			                    <td class="text-right currency">{{ single_price($orderDetail->cam_price * $orderDetail->qty) }}</td>
							</tr>
		        ...
		        <tbody>
			        ...
			        <tr>
			            <td class="text-left">
                            ...
                            @endphp
                            {!! str_replace($removedXML,"", QrCode::size(100)->generate($info->id)) !!}
			            </td>
					        ...
					        <table class="text-right sm-padding small strong">
						        <tbody>
							        <tr>
							            ...
							            <td class="currency">{{ single_price($info->amount) }}</td>
							        </tr>
							        <tr>
