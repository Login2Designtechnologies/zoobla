...
<body>
	...
	<div>
		...
		<div style="background:#1dbae8;padding: 1rem;">
		...
		<div style="padding: 1rem;padding-bottom: 0">
            ...
            <table>
				...
				<tr><td class="strong small gry-color"><b>{{ translate('Bill to') }}:</b></td></tr>
					        ...
					        <table class="text-right sm-padding small strong">
						        ...
						        <tbody>
							        ...
							        <tr>
							            ...
							            <th class="text-left strong"><b>{{ translate('Grand Total') }}</b></th>
