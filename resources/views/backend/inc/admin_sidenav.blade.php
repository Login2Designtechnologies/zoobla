    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @canany(['add_new_product', 'show_all_products','show_in_house_products','show_seller_products','show_digital_products','product_bulk_import','product_bulk_export','view_product_categories', 'view_all_brands','view_product_attributes','view_colors','view_product_reviews' ,'view_all_coupons'])
                 ...
                 @canany(['view_all_orders', 'view_inhouse_orders','view_seller_orders','view_pickup_point_orders'])
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{translate('Order management')}}</span>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('view_seller_orders')
                                ...
                                <li class="aiz-side-nav-item">
                                    ...
                                    <a href="{{ route('seller_orders.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['seller_orders.index', 'seller_orders.show'])}}">
                                        ...
                                        <span class="aiz-side-nav-text">{{translate('Partner Orders')}}</span>
                            ...
                            @can('view_all_service_orders')
                                <li class="aiz-side-nav-item">

                                    <a href="{{ route('all_service_orders.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['all_service_orders.index', 'all_service_orders.show'])}}">
                            ...
                            @can('view_seller_service_orders')

                                <li class="aiz-side-nav-item">

                                    <a href="{{ route('seller_service_orders.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['seller_service_orders.index', 'seller_service_orders.show'])}}">

                                        <span class="aiz-side-nav-text">{{translate('Partner Service Orders')}}</span>
                ...
                <!-- BUNDLE Discount Management -->
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <a href="{{url('admin/discount/index')}}" class="aiz-side-nav-link">
                            
                            <i class="las la-backward aiz-side-nav-icon"></i>

                            <span class="aiz-side-nav-text">{{translate('Bundle Discount Management')}}</span>
               ...
               @canany(['view_all_customers','view_classified_products','view_classified_packages'])
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{ translate('Users Management') }}</span>
                 ...
                 @canany(['view_all_seller','seller_payment_history','view_seller_payout_requests','seller_commission_configuration','view_all_seller_packages','seller_verification_form_configuration'])
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{ translate('Partner Management') }}</span>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('seller_commission_configuration')
                                ...
                                <li class="aiz-side-nav-item">
                                    ...
                                    <a href="{{ route('business_settings.vendor_commission') }}" class="aiz-side-nav-link">
                                        ...
                                        <span class="aiz-side-nav-text">{{ translate('Partners Commission') }}</span>
                            ...
                            @can('seller_commission_configuration')
                                ...
                                <li class="aiz-side-nav-item">
                                    ...
                                    <a href="{{ route('business_settings.service_commission') }}" class="aiz-side-nav-link">

                                        <span class="aiz-side-nav-text">{{ translate('Partners Residual Commission') }}</span>
                                ...
                                @can('view_all_seller_packages')
                                    ...
                                    <li class="aiz-side-nav-item">
                                        ...
                                        <a href="{{ route('seller_packages.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['seller_packages.index', 'seller_packages.create', 'seller_packages.edit'])}}">
                                            ...
                                            <span class="aiz-side-nav-text">{{ translate('Partners Packages') }}</span>
                            ...
                            @can('seller_verification_form_configuration')
                               ...
                               {{-- <li class="aiz-side-nav-item">
                                    ...
                                    <a href="{{ route('seller_verification_form.index') }}" class="aiz-side-nav-link">
                                        ...
                                        <span class="aiz-side-nav-text">{{ translate('Partners Verification Form') }}</span>
                ...
                @canany(['in_house_product_sale_report','seller_products_sale_report','products_stock_report','product_wishlist_report','user_search_report','commission_history_report','wallet_transaction_report','user_history_report' ,'partner_history_report' ,'sales_report' ,'service_sales_report' ,'Sales-comparison-report'])
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('user_history_report')

                                <li class="aiz-side-nav-item">

                                    <a href="{{ route('user-history.index') }}" class="aiz-side-nav-link">

                                        <span class="aiz-side-nav-text">{{ translate('User History Report') }}</span>
                            ...
                            @can('partner_history_report')

                                <li class="aiz-side-nav-item">

                                    <a href="{{ route('partner_history.index') }}" class="aiz-side-nav-link">

                                        <span class="aiz-side-nav-text">{{ translate('Partner History Report') }}</span>
                            ...
                            @can('sales_report')
                                ...
                                <li class="aiz-side-nav-item">
                                    ...
                                    <a href="{{ route('sales_report.index') }}" class="aiz-side-nav-link">
                            ...
                            @can('service_sales_report')

                                <li class="aiz-side-nav-item">

                                    <a href="{{ route('service_sales_report.index') }}" class="aiz-side-nav-link">

                                        <span class="aiz-side-nav-text">{{ translate('Service Sales Report') }}</span>
                            ...
                            @can('Sales-comparison-report.blade.php')

                            <li class="aiz-side-nav-item">

                                <a href="{{ route('sales_comparison_report.index') }}" class="aiz-side-nav-link">

                                    <span class="aiz-side-nav-text">{{ translate('Sales Comparison Report') }}</span>
                ...
                @can('vat_&_tax_setup')
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <a href="{{route('tax.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['tax.index', 'tax.create', 'tax.store', 'tax.show', 'tax.edit'])}}">
                            ...
                            <span class="aiz-side-nav-text">{{translate('Tax Management')}}</span>
                ...
                @endcan
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <a href="#" class="aiz-side-nav-link {{ areActiveRoutes(['tax.cloud_list', 'tax.cloud_product_list'])}}" >

                            <i class="las la-cloud-upload-alt aiz-side-nav-icon"></i>

                            <span class="aiz-side-nav-text">{{translate('Cloud Setting')}}</span>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                                ...
                                {{-- <li class="aiz-side-nav-item">
                                    ...
                                    <a href="{{ route('tax.cloud_list') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{translate('Cloud Storage')}}</span>
                                ...
                                <li class="aiz-side-nav-item">
                                   ...
                                   <a href="{{ route('tax.cloud_product_list') }}" class="aiz-side-nav-link">

                                        <span class="aiz-side-nav-text">{{translate('Cloud Products')}}</span>
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <a href="{{url('admin/notifications')}}" class="aiz-side-nav-link">
                            <i class="las la-hand-holding-usd aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">Notifications</span>
