                ...
                <table class="table aiz-table mb-0">
                    ...
                    <tbody>
                        ...
                        @foreach ($orders as $key => $order)
                            ...
                            @if(isset($order->orderDetails[0]['product_referral_code']) && $order->orderDetails[0]['product_referral_code'] != null && $seller_type != null)
                             ...
                             <a href="{{ $order_detail_route }}">
                                ...
                                @if($seller_type != null)
                                    <td>
                                        ...
                                        {{ single_price( get_total_order_commission($name->id,($order->product_price > 0) ? $order->product_price : $order->grand_total)) }}
