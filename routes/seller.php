...
Route::group(['namespace' => 'App\Http\Controllers\Seller', 'prefix' => 'seller', 'middleware' => ['seller', 'verified', 'user', 'prevent-back-history'], 'as' => 'seller.'], function () {
    ...
    Route::controller(InvoiceController::class)->group(function () {
        ...
        Route::get('/service-invoice/{order_id}', 'service_invoice_download')->name('service_invoice.download');
...
Route::get('seller/service/service-list' , [ServiceController::class , 'index'])->name('seller.service.service_list');

Route::get('seller/service/service-show/{id}', [ServiceController::class , 'service_show'])->name('seller.service.service_show');

Route::get('seller/commission-history' , [ServiceController::class , 'commission_history'])->name('seller.service.commission_history');
