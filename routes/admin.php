...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function() {
    ...
    Route::controller(ProductController::class)->group(function () {
        ...
        Route::get('/products/lowquantity-cronmail', 'lowquantity_cronmail')->name('lowquantity-cronmail');

        Route::get('/products/wishlist-cronmail', 'wishlist_cronmail')->name('wishlist-cronmail');
    ...
    Route::controller(BusinessSettingsController::class)->group(function () {
        ...
        Route::get('/service_commission', 'service_commission')->name('business_settings.service_commission');

        Route::post('/vendor_commission_update', 'vendor_commission_update')->name('business_settings.vendor_commission.update'); 
        
        Route::post('/payout_transaction_update', 'payout_transaction_update')->name('business_settings.payout_transaction.update');
    ...
    Route::controller(TaxController::class)->group(function () {
        ...
        Route::get('cloud_create', 'cloud_create')->name('tax.cloud_create');

        Route::get('cloud_list', 'cloud_list')->name('tax.cloud_list');

        Route::post('/tax/cloud_store', 'cloud_store')->name('tax.cloud_store');

        Route::get('/tax/cloud_edit/{id}', 'cloud_edit')->name('tax.cloud_edit');

        Route::post('/tax/cloud_update/{id}', 'cloud_update')->name('tax.cloud_update');

        Route::get('/tax/cloud_delete/{id}', 'cloud_delete')->name('tax.cloud_delete');


        Route::get('cloud_product_create', 'cloud_product_create')->name('tax.cloud_product_create');

        Route::get('cloud_product_list', 'cloud_product_list')->name('tax.cloud_product_list');

        Route::post('/tax/cloud_product_store', 'cloud_product_store')->name('tax.cloud_product_store');

        Route::get('/tax/cloud_product_edit/{id}', 'cloud_product_edit')->name('tax.cloud_product_edit');

        Route::post('/tax/cloud_product_update/{id}', 'cloud_product_update')->name('tax.cloud_product_update');

        Route::get('/tax/cloud_product_delete/{id}', 'cloud_product_delete')->name('tax.cloud_product_delete');
    ...
    Route::controller(ServiceorderController::class)->group(function () {
        ...
        Route::get('/all_service_orders', 'all_orders')->name('all_service_orders.index');

        Route::get('/seller_service_orders', 'all_orders')->name('seller_service_orders.index');

        Route::get('/service-orders/{id}/show', 'show')->name('all_service_orders.show');

        Route::get('/seller_service_orders/{id}/show', 'show')->name('seller_service_orders.show');
        
        Route::get('/service-orders/destroy/{id}', 'destroy')->name('service-orders.destroy');

        Route::post('/bulk-service-order-delete', 'bulk_order_delete')->name('bulk-service-order-delete');
    });
    ...
    Route::controller(ReportController::class)->group(function () {
        ...
        Route::get('/user-history', 'user_registration_history')->name('user-history.index'); 

        Route::get('/partner-history', 'partner_history')->name('partner_history.index'); 

        Route::get('/sales-report', 'sales_report')->name('sales_report.index'); 
        
        Route::get('/service-sales-report', 'service_sales_report')->name('service_sales_report.index'); 

        Route::get('/sales-comparison-report', 'sales_comparison_report')->name('sales_comparison_report.index'); 

    });

    Route::controller(ReportExportController::class)->group(function () {

        Route::get('/sales-report-export', 'export')->name('sales_report_export.index');

        Route::get('/users-report-export', 'user_export')->name('users_report_export.index');

        Route::get('/partners-report-export', 'partner_export')->name('partners_report_export.index');
        
        Route::get('/service-sales-report-export', 'service_sales_export')->name('service_sales_report_export.index');
    ...
    Route::get('/edit-notifications/{id}', [NotificationController::class, 'editnotifications'])->name('admin.editnotifications');

  Route::get('/deletenotifications/{id}', [NotificationController::class, 'deletenotifications'])->name('admin.deletenotifications');


    Route::put('/update-notifications/{id}', [NotificationController::class, 'updatenotifications'])->name('admin.updatenotifications');

    Route::get('/add-notifications', [NotificationController::class, 'storenotifications'])->name('admin.storenotifications');
    Route::post('/store', [NotificationController::class, 'store'])->name('admin.store');
